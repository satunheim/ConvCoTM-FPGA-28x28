...
#EDITED:
set_property PACKAGE_PIN D5 [get_ports o_LED1_InitialState]
set_property IOSTANDARD LVCMOS33 [get_ports o_LED1_InitialState]
set_property PACKAGE_PIN D6 [get_ports o_LED2_FinishedInference]
set_property IOSTANDARD LVCMOS33 [get_ports o_LED2_FinishedInference]
set_property PACKAGE_PIN A5 [get_ports o_LED3_FinishedLearn]
set_property IOSTANDARD LVCMOS33 [get_ports o_LED3_FinishedLearn]
set_property PACKAGE_PIN B5 [get_ports o_blinkout]
set_property IOSTANDARD LVCMOS33 [get_ports o_blinkout]
#ORIGINAL:
